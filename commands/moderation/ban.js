...
module.exports = {
  ...
  async execute(client, message, args) {
    ...
    if(!message.member.hasPermission("BAN_MEMBERS")) return message.reply(`You don't have enough perms to ban someone`)
    
    if(!message.guild.me.hasPermission("BAN_MEMBERS")) return message.reply(`I don't have perms to ban someone`)
